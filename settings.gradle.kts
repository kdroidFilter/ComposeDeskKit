...
include(":examples:satellite-demo")
include(":examples:tabs-demo")
include(":examples:jewel-tabs-demo")
include(":examples:tab-satellites-demo")
include(":examples:reader-dock-demo")
