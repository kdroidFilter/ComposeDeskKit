...
import io.github.kdroidfilter.composedeskkit.desktop.application.internal.JvmApplicationContext
import io.github.kdroidfilter.composedeskkit.desktop.application.internal.packageBuildVersionFor
import io.github.kdroidfilter.composedeskkit.desktop.application.internal.packageVersionFor
...
private object DebVersionChecker : VersionChecker {
    override val correctFormat =
        """|'[EPOCH:]UPSTREAM_VERSION[-DEBIAN_REVISION]', where:
    ...
    override fun isValid(version: String): Boolean = version.matches(debRegex)
