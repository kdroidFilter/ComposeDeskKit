@echo off
REM Compiles nucleus_windows_theme.c into per-architecture DLLs (x64 + ARM64).
...
set "SCRIPT_DIR=%~dp0"
set "SRC=%SCRIPT_DIR%nucleus_windows_theme.c"
...
echo.
echo Built DLLs:
if exist "%OUT_DIR_X64%\nucleus_windows_theme.dll" echo   %OUT_DIR_X64%\nucleus_windows_theme.dll
if exist "%OUT_DIR_ARM64%\nucleus_windows_theme.dll" echo   %OUT_DIR_ARM64%\nucleus_windows_theme.dll
